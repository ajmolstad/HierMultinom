...
write.csv(result, file.path(FIGURES_PATH, "application_figure.csv"))
...
library(cowplot)
pdf(file.path(FIGURES_PATH, "application_figure.pdf"), width=7.2, height=3.8)
wrap_plots(p1, p2, p3, p4, p5, p6, nrow = 2) & theme(legend.position = "")
...
pdf(file.path(FIGURES_PATH, "application_figure_legend.pdf"), width=7.2, height=0.6)
